    ...
    for iSpeaker=1:51
        ...
        for iTotalLen = 1:totalLen
            ...
            if 1
                ...
                saveFileName = sprintf('./Imgs/S%02d_value_%02d.png',iSpeaker,iTotalLen);
                saveas(gcf,saveFileName);
                set(0,'CurrentFigure',hPi);
                saveFileName = sprintf('./Imgs/S%02d_pi_%02d.png',iSpeaker,iTotalLen);
                saveas(gcf,saveFileName);
            end
