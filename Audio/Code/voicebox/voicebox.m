...
if isempty(PP)
    ...
    PP.dir_temp='D:\Program Files\voicebox\\TEMP';                      % directory for storing temporary files
    PP.dir_data='D:\Program Files\voicebox\dmb\data\speech';           % default directory to preappend to speech data file names
    PP.shorten='D:\Program Files\voicebox\bin\shorten.exe';            % location of shorten executable
    PP.flac='D:\Program Files\voicebox\bin\flac.exe';                  % location of flac executable
    PP.sfsbin='D:\Program Files\voicebox\SFS\Program';   % location of Speech Filing Sysytem binaries
